...
<div class="col-lg-8">
                      <section class="panel">                        
                        <header class="panel-heading">
                         ...
                         Nilai &alpha;-predikat dan Z dari setiap aturan               
                        <div class="panel panel-success">
                          <div class="panel-heading"><strong>Rule 1 :</strong><em>        IF permintaan TURUN and persediaan BANYAK THEN produksi barang BERKURANG</em><br /></div>
                          <div class="panel-content"> 
                                      ...
                                      diperoleh <strong>z<sub>1</sub></strong>=<?=$z1?></div>
                        </div>
                        <div class="panel panel-primary">
                          <div class="panel-heading"><strong>Rule 2 :</strong><em>IF permintaan TURUN and persediaan SEDIKIT THEN produksi barang BERKURANG</em><br /></div>
                          <div class="panel-content"><?php
                                  ...
                                  diperoleh <strong>z<sub>2</sub></strong>=<?=$z2?></div>
                        </div>
                        <div class="panel panel-warning">
                          <div class="panel-heading"><strong>Rule 3 :</strong><em>IF permintaan NAIK and persediaan BANYAK THEN produksi barang BERTAMBAH</em><br /></div>
                          <div class="panel-content"><?php
                              ...
                              diperoleh <strong>z<sub>3</sub></strong>=<?=$z3?></div>
                        </div>
                        <div class="panel panel-info">
                          <div class="panel-heading"><strong>Rule 4 :</strong><em>IF permintaan NAIK and persediaan SEDIKIT THEN produksi barang BERTAMBAH</em><br /></div>
                          <div class="panel-content"><?php
                                    ...
                                    diperoleh <strong>z<sub>4</sub></strong>=<?=$z4?></div>
                        </div>
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                            ...
                            <div class="alert alert-success fade in">
                                  ...
                                  Jadi jumlah yang harus diproduksi sebanyak (<strong>z</strong>) =<strong><?=$z?></strong> kemasan
                              </div>      
                          </div>
                      </section>
                      </div>
